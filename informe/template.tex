...
\author{Assenza, Franco\thanksref{faemail}}
\address{LU: 921/12}

\author{Maldonado, Kevin\thanksref{kmemail}}
\address{LU: 018/14}

\author{Umfurer, Alfredo\thanksref{auemail}}
\address{LU: 538/12}
...
%Please list keywords for your paper here, separated by commas.
  Regresi\'on lineal, Retrasos de vuelos, bolsa
\end{keyword}
...
\bibitem{esl} Hastie, T., ``The Elements of Statistical Learning: Data Mining, Inference, and Prediction,''
2nd Ed., Springer, 2019.

\bibitem{burden} Burden, R., and Faires, J., ``Numerical Analysis,''
9th Ed., Brooks/Cole, 2011.

\bibitem{timeseries} Shumway, R., and Stoffer, D., ``Time Series Analysis and Its Applications,''
3rd Ed., Springer, 2010.
  \bibitem{stats} Witte, R., and Witte, J., ``Statistics,`` 9th Ed.,
